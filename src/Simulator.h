...
public:
    ...
    void Controlled_T(int cont, int targ);
    void MAJ_Controlled_X(int targ, int c1, int c2, int c3);
    ...
    void measurement();
    void getStatevector();
    std::pair<long double, long double> get_amplitude_value(int *assign);
    void print_basis_probabilities(std::string label = "");
    void print_basis_extremes(std::string label = "");
    void print_basis_range(long double min_prob, long double max_prob, std::string label = "");
    ...
    long double min_prob_val = 0.0L;
    long double max_prob_val = 1.0L;
...
private:
    ...
    DdNode ***copy_current_state();
    void free_state_copy(DdNode ***state);
    void restore_from_state_copy(DdNode ***state);
    ...
    void nodecount();
    void execute_gate_line(std::string gate, std::stringstream& inStr_ss);
